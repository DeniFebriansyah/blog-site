export const my_blogs = {
  ...
  blog_2: {
    title: "Feedback About Stackup",
    author: "Deni",
    date: "2023-01-24",
    content:
      "Stackup is very helpful in learning something new that allows programmers to be more creative in forming a basic competency. Many of the Stackup users who don't understand the world of programming are very fun. Learning to make a program from Stackup makes me more proficient in a campus environment where I follow step by step provided by Stackup to solve a problem",
  },
};
